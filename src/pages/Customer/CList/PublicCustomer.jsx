...
import { ggCustomerList } from "../../../services/customer";
...
const CustomerList = () => {
    ...
    const onSearch = () => {
        form.validateFields().then((values) => {
            ...
            setCurrentPage(1);
            // ggCustomerList({ ...values, pageNo: currentPage, pageSize: 10 }).then((data) => {
            //   // console.log(data);
            //   setCustomerList(
            //     data.list.map((item) => {
    ...
    const onClear = () => {
        ...
        setCurrentPage(1);
        // ggCustomerList({ pageNo: currentPage, pageSize: 10 }).then((data) => {
        //   // console.log(data);
        //   setCustomerList(
        //     data.list.map((item) => {
        //       return Object.assign(item, {
    ...
    useEffect(() => {
        ...
        //   });
        // });
        ggCustomerList({ pageNo: currentPage, pageSize: 10, ...searchValues }).then(res => {
            const { data } = res;
            console.log(res);
            setCustomerList(
                data?.list.map((item) => {
