...
import { hzCustomerList } from "../../../services/customer";
...
const CustomerList = () => {
    ...
    const onClear = () => {
        ...
        setCurrentPage(1);
        // hzCustomerList({ pageNo: currentPage, pageSize: 10 }).then((data) => {
        //   // console.log(data);
        //   setCustomerList(
        //     data.list.map((item) => {
        //       return Object.assign(item, {
    ...
    useEffect(() => {
        ...
        //   });
        // });
        hzCustomerList({ pageNo: currentPage, pageSize: 10, ...searchValues }).then(res => {
            const { data } = res;
            console.log(res);
            setCustomerList(
                data?.list.map((item) => {
